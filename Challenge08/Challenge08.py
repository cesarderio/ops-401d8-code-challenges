...
def run_ransom_script():
    # Run "runrans.py" in the current directory
    subprocess.run(["python", "runrans.py"])

    print("Ransomware script ran successfully.")
...
def main():
    while True:
        ...
        print("11. Run ransomware script")
        print("0. Exit")
