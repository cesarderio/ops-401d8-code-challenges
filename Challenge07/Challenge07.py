...
# Purpose:                      Create a python script that adds a feature capability to your script to:
...
def encrypt_folder(folder_path):
    ...
    print("Folder and all contents encrypted successfully.")
...
def decrypt_folder(folder_path):
    ...
    print("Folder and all contents decrypted successfully.")
